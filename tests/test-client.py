...
class TestClient(object):
    ...
    def test_stream(stream):
        ...
        for message in stream:
            ...
            if i % 2 == 0:
                assert message.data.decode("utf8") == "active2", "Expected active2, got %s" % message.data
            else:
                assert message.data.decode("utf8") == "active1", "Expected active1, got %s" % message.data
